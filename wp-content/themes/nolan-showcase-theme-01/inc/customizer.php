...
function nolan_customize_register( $wp_customize ) {
	$wp_customize->add_section(
		'nolan_home',
		array(
			'title'    => __( 'Home Content', 'nolan-showcase-theme-01' ),
			'priority' => 30,
		)
	);
