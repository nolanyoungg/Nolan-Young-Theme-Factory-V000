...
<header class="site-header">
	<div class="container header-bar">
		<div class="brand-mark">
			<a class="brand-link" href="<?php echo esc_url( home_url( '/' ) ); ?>">
				...
				<span class="brand-copy">
					...
					<span><?php esc_html_e( 'Boutique photography studio', 'nolan-showcase-theme-01' ); ?></span>
				</span>
			</a>
		</div>
		...
		<button class="nav-toggle" type="button" aria-expanded="false" aria-controls="primary-navigation">
			...
			<span class="nav-toggle__bar"></span>
			<span class="nav-toggle__bar"></span>
			<span class="screen-reader-text"><?php esc_html_e( 'Toggle navigation', 'nolan-showcase-theme-01' ); ?></span>
		</button>

		<nav class="site-nav" id="primary-navigation" aria-label="<?php esc_attr_e( 'Primary', 'nolan-showcase-theme-01' ); ?>">
			<?php
			wp_nav_menu(
				array(
