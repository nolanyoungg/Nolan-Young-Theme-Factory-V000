...
Codex command: `codex exec --model gpt-5.5 -c model_reasoning_effort="high"`
...
Task:
- generate the complete classic WordPress theme from scratch at wp-content/themes/002_nolan_young_theme_astragrid_systems/
- generate the matching static preview from scratch at docs/themes/002_nolan_young_theme_astragrid_systems/
...
- Your first filesystem action must create wp-content/themes/002_nolan_young_theme_astragrid_systems/, docs/themes/002_nolan_young_theme_astragrid_systems/, reports/runs/002_nolan_young_theme_astragrid_systems/generation-progress.md, and a short progress note. Do this before extended planning.
...
- After the progress marker, immediately write the validator-critical roots and assets in small batches: style.css, functions.php, header.php, footer.php, front-page.php, assets/css/theme.css, assets/js/theme.js, docs/themes/002_nolan_young_theme_astragrid_systems/index.html, docs/themes/002_nolan_young_theme_astragrid_systems/homepage_preview.html, docs/themes/002_nolan_young_theme_astragrid_systems/assets/css/preview.css, and docs/themes/002_nolan_young_theme_astragrid_systems/assets/js/preview.js.
...
- If you need a helper generator script for large file output, keep it under reports/runs/002_nolan_young_theme_astragrid_systems/ and use it immediately to write the generated files.
...
Nolan Young Theme 002 - AstraGrid Systems

Expected final output paths:

wp-content/themes/002_nolan_young_theme_astragrid_systems/
docs/themes/002_nolan_young_theme_astragrid_systems/
dist/zipped-themes/002_nolan_young_theme_astragrid_systems.zip
reports/runs/002_nolan_young_theme_astragrid_systems/
...
* Update docs/index.html by adding one polished visible gallery card linking to themes/002_nolan_young_theme_astragrid_systems/index.html.
* docs/index.html must preserve all existing generated showcase cards and add this generated 002 theme as another visible card.
* No lorem ipsum.
* No placeholder copy.
* No TODO text.
...
* Preserve all existing generated showcase cards and add one visible showcase card for this generated 002 theme.
* Include a small homepage snapshot using an embedded local iframe or a local visual preview.
* Link to themes/002_nolan_young_theme_astragrid_systems/index.html.
