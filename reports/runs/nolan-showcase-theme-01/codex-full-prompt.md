...
Create a complete theme at `wp-content/themes/nolan-showcase-theme-01/`, a static preview at `docs/themes/nolan-showcase-theme-01/`, and update `docs/index.html`.
Do not produce a weak fallback. Build a full polished website that satisfies all contracts.
